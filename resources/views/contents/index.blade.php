    ...
    <section
        ...
        <div class="flex flex-col">
            <x-displays.accordion
                ...
                <x-displays.card-accordion image="images/articles/pola-pikir-seorang-wirausaha.webp" videoId="6331201181112" slug="pola-pikir-wirausaha">
            ...
            <x-displays.accordion
                ...
                <x-displays.card-accordion image="images/articles/menemukan-dan-menguji-ide-startup-anda.webp" videoId="6331201181112" slug="menemukan-menguji-ide-startup">
            ...
            <x-displays.accordion
                ...
                <x-displays.card-accordion image="images/articles/cara-menemukan-nama-yang-tepat.webp" videoId="6331201181112" slug="cara-menemukan-nama-tepat">
            ...
            <x-displays.accordion
                ...
                <x-displays.card-accordion image="images/articles/manfaat-halaman-tujuan-landing-page.webp" videoId="6331201181112" slug="manfaat-halaman-tujuan">
            ...
            <x-displays.accordion
                ...
                :last="true">
                <x-displays.card-accordion image="images/articles/cara-efektif-untuk-memasarkan-perusahaan-anda.webp" videoId="6331201181112" slug="memasarkan-bisnis-anda">
