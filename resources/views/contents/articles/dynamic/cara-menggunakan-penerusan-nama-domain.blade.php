<section class="article-outer">
    <div class="article-wrapper">
        ...
        <div class="flex flex-col gap-2">
            <h3 class="title-arrow">Media Sosial</h3>
        ...
        <div class="flex flex-col gap-2">
            <h3 class="title-arrow">Toko Online</h3>
            <div class="flex flex-col">
        ...
        <x-articles.tip-callout>
            ...
            <p>Siap mempelajari cara meneruskan nama domain? Artikel kami menjelaskan berbagai metode penerusan nama domain, atau Anda dapat melihat video langkah demi langkah tentang cara meneruskan nama domain.</p>
        </x-articles.tip-callout>
