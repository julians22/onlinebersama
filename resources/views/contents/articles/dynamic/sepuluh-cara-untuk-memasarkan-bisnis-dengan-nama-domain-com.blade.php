    ...
    <div class="article-wrapper">
        ...
        <div class="article-child-wrapper pl-4">
            <x-articles.step-item :number="1">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Alamat Email</h4>
            ...
            <x-articles.step-item :number="2">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Video Bermerek</h4>
            ...
            <x-articles.step-item :number="3">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Direktori Online</h4>
            ...
            <x-articles.step-item :number="4">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Profil Media Sosial</h4>
            ...
            <x-articles.step-item :number="5">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Kampanye Pemasaran</h4>
            ...
            <x-articles.step-item :number="6">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Profil bisnis di aplikasi pesan</h4>
        ...
        <div class="article-child-wrapper pl-4">
            <x-articles.step-item :number="7">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Pesan Langsung</h4>
            ...
            <x-articles.step-item :number="8">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Kartu Nama Bisnis</h4>
            ...
            <x-articles.step-item :number="9">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Label Produk / Branding</h4>
            ...
            <x-articles.step-item :number="10">
                <div class="flex gap-2 flex-col flex-1">
                    <h4 class="subheadline-4 text-deep-blue-300 font-semibold!">Iklan Cetak</h4>
