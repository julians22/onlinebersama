<section class="article-wrapper">
    <x-articles.intro-and-quicklinks>
        <div class="article-child-wrapper">
            ...
            <div class="flex flex-col gap-3">
                <a href="#membangun-kredibilitas" class="font-sans text-[22px] font-semibold leading-[140%] text-deep-blue-300">1: Membangun Kredibilitas</a>
                <a href="#membangun-legitimasi-dengan-citra-profesional" class="font-sans text-[22px] font-semibold leading-[140%] text-deep-blue-300">2: Membangun Legitimasi Dengan Citra Profesional</a>
                <a href="#memasarkan-keseluruhan-bisnis-anda" class="font-sans text-[22px] font-semibold leading-[140%] text-deep-blue-300">3: Memasarkan Keseluruhan Bisnis Anda</a>
            </div>
        </div>
    </x-articles.intro-and-quicklinks>
    ...
    <div id="membangun-kredibilitas" class="article-child-wrapper scroll-mt-20 sm:scroll-mt-28">
    ...
    <div id="memasarkan-keseluruhan-bisnis-anda" class="article-child-wrapper scroll-mt-20 sm:scroll-mt-28">
