...
@section('meta_image', imageArticle($post->thumbnail_file_name))
    ...
    @if ($post->isCustomTemplate())
        ...
        <section
            ...
            <div class="container grid grid-cols-1 items-center gap-6 py-10 md:gap-10 md:py-19.5 lg:grid-flow-col">
                ...
                <div class="relative aspect-video w-full rounded-[10px] overflow-hidden lg:w-156.75">
                    <img class="w-full" src="{{ imageArticle($post->thumbnail_file_name) }}" alt="">
                </div>
            </div>
        </section>
        @include($view_path)
