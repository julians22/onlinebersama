...
<div class="namestudio-container relative w-full">
    ...
    <script type="application/json" data-type="name-studio">{"i18n":{"id":{"namestudio-search":{"prompt":{"placeholder":"Temukan Nama Domain","btnreset":"","btngenerate":"Cari","btngenerateloading":"Cari","btngenerateregenerate":"Cari"}}}},"legal":{"terms":"https://onlinebersama.com/staging/persyaratan-layanan"}}</script>
