...
<div class="namestudio-container relative w-full z-10 mt-6">
    ...
    <script type="application/json" data-type="name-studio">{"i18n":{"id":{"namestudio-search":{"prompt":{"placeholder":"Masukkan Kata, Frasa, atau Nama Bisnis","btnreset":"","btngenerate":"Cari","btngenerateloading":"Cari","btngenerateregenerate":"Cari"}}}},"legal":{"terms":"https://onlinebersama.com/persyaratan-layanan"}}</script>
        <button slot="btn-results-close" class="btn-results-close" data-analytics-name="button | Close">
            <span>Tutup</span>
