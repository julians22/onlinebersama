    ...
    <nav class="nav-misc">
        <div class="flex justify-between items-center gap-2.5 py-2 lg:py-5 container">
            ...
            <div class="flex items-center gap-x-10">
                <ul class="hidden lg:gap-x-4 xl:gap-x-10 lg:flex">
                    <li><a href="{{ route('index') }}#mengapa-com" class="nav-link">Mengapa .com?</a></li>
                    <li>
                        <button type="button" @click="open = !open" class="nav-link nav-dropdown">
                    ...
                    <li><a href="{{ route('resources') }}" class="nav-link">Panduan Belajar</a></li>
                </ul>
