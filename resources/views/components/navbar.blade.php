        ...
        <div class="container flex justify-between items-center gap-2.5 py-2 lg:py-5">
            ...
            <div class="flex items-center gap-x-10">
                <ul class="hidden gap-x-10 lg:flex">
                    <li><a href="#" class="font-medium leading-6 text-white text-xl">Mengapa .com?</a></li>
                    <li>
                    ...
                    <li><a href="#" class="font-medium leading-6 text-white text-xl">Panduan Belajar</a></li>
                </ul>
                <a href="{{ route('find') }}" class="btn-primary font-medium text-navy-blue-300 px-4 py-0.5 lg:px-6 lg:py-2">
        ...
        <div x-cloak class="absolute grid grid-cols-12 w-full transition-all duration-300 ease-in-out bg-white left-0 top-0" :class="open ? 'translate-y-0' : '-translate-y-full'">
            <div class="col-span-9 grid grid-cols-3 h-max gap-10 p-10">
                <a href="{{ route('websites') }}" class="group flex transition-all duration-300 ease-in-out gap-5 p-6 rounded-[10px] min-h-54.25 hover:bg-mint-100">
                    <div class="space-y-4">
                        <h3 class="subheadline-3 text-navy-blue-300">.com untuk Situs Web</h3>
                        <p class="paragraph-sm font-bold text-deep-blue-300">Agar lebih mudah ditemukan, mulailah menggunakan situs web .com Anda sendiri.</p>
                    </div>
                ...
                <a href="{{ route('email') }}" class="group flex transition-all duration-300 ease-in-out gap-5 p-6 rounded-[10px] min-h-54.25 hover:bg-mint-100">
                    <div class="space-y-4">
                        <h3 class="subheadline-3 text-navy-blue-300">.com untuk Email</h3>
                        <p class="paragraph-sm font-bold text-deep-blue-300">Jadikan email sebagai pernyataan kredibilitas.</p>
                    </div>
                    <div class="transition-all duration-300 ease-in-out shrink-0 mt-2.5 opacity-0 group-hover:opacity-100">
                        <img src="{{ asset('icons/navy-chevron-right.svg') }}">
                    </div>
                ...
                <a href="{{ route('social-media') }}" class="group flex transition-all duration-300 ease-in-out gap-5 p-6 rounded-[10px] min-h-54.25 hover:bg-mint-100">
                    <div class="space-y-4">
                        <h3 class="subheadline-3 text-navy-blue-300">.com untuk <span class="block">Media Sosial dan</span> E-Commerce </h3>
                        <p class="paragraph-sm font-bold text-deep-blue-300">Dapatkan alamat web .com untuk eksistensi online Anda.</p>
                    </div>
                    <div class="transition-all duration-300 ease-in-out shrink-0 mt-2.5 opacity-0 group-hover:opacity-100">
                        <img src="{{ asset('icons/navy-chevron-right.svg') }}">
                    </div>
