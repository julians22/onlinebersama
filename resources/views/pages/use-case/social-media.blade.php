...
<main>
    <section class="bg-light-gray-100">
        <div class="flex justify-between items-center flex-col gap-10.75 py-10 container md:gap-20 md:py-15.5 lg:flex-row">
            ...
            <button type="button" class="group relative rounded-[10px] overflow-hidden shrink-0 cursor-pointer">
                ...
                <img class="box-shadow-sm w-156 object-cover aspect-video lg:w-125 xl:w-156" src="{{ asset('images/uc-social-media-ecommerce.jpg') }}" alt="">
    ...
    <section class="py-10 container">
        ...
        <div class="flex flex-col gap-6 mx-auto max-w-md md:max-w-208">
            ...
            <div class="top-66 sticky card-stack md:top-92">
    ...
    <section class="bg-deep-blue-300">
        <div class="max-w-380 mx-auto pt-10 pb-19.5 px-4 md:px-8 xl:px-0">
            ...
            <div x-data="{ active: 'social-media' }" class="flex flex-col justify-center gap-4 md:flex-row">
                ...
                <a x-show="active === 'social-media'" href="#" class="relative rounded-[10px] max-w-full overflow-hidden h-88 md:h-auto md:max-w-156">
                ...
                <a x-show="active === 'online-store'" x-cloak href="#" class="relative rounded-[10px] max-w-full overflow-hidden h-88 md:h-auto md:max-w-156">
